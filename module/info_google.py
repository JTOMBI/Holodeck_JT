...
servers = [
    {"hostname": "192.168.75.129", "username": "jtombi", "key_path": "/home/py/.ssh/id_rsa"},  # MariaDB
    {"hostname": "192.168.75.132", "username": "jtombi", "key_path": "/home/py/.ssh/id_rsa"},  # WebServer
    {"hostname": "192.168.75.133", "username": "jtombi", "key_path": "/home/py/.ssh/id_rsa"}   # SFTPServer
]
...
def monitor_servers():
    ...
    for server in servers:
        ...
        server_status = check_server(server["hostname"], 3306 if server["hostname"] == "192.168.75.1" else 80 if server["hostname"] == "192.168.75.1" else 22)
        if server_status:
